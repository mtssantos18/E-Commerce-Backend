...
export class initialMigration1671126346608 implements MigrationInterface {
    name = 'initialMigration1671126346608'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "car" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying NOT NULL, "km" numeric(10,2) NOT NULL, "year" integer NOT NULL, "coverImage" character varying NOT NULL, "price" numeric(10,2) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_55bbdeb14e0b1d7ab417d11ee6d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "motorcycle" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying NOT NULL, "km" numeric(10,2) NOT NULL, "year" integer NOT NULL, "coverImage" character varying NOT NULL, "price" numeric(10,2) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_376a2d7dc14cdf2c1b73fb4049d" PRIMARY KEY ("id"))`);
